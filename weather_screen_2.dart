...
class WeatherScreenTwo extends StatefulWidget {
  const WeatherScreenTwo({super.key});

  @override
  State<WeatherScreenTwo> createState() => _WeatherScreenState();
}

class _WeatherScreenState extends State<WeatherScreenTwo> {
  ...
  Future<Map<String, dynamic>> getCurrentWeather(String cityName) async {
    try {
      final cachedData = await _getWeatherData(cityController.text);
      if(cachedData != null) {
        return cachedData;
      }
      ...
      await _saveWeatherData(cityController.text, data);
